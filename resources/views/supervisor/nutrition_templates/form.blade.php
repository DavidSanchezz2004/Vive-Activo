...
@php
    ...
    $action = $isEdit ? route('supervisor.nutrition_templates.update', $template) : route('supervisor.nutrition_templates.store');
@endphp
...
<div class="d-card" style="margin-bottom: 16px;">
    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;">
        ...
        <a class="d-btn" href="{{ route('supervisor.nutrition_templates.index') }}">Volver</a>
    </div>
</div>
