...
<div class="d-card" style="margin-bottom: 16px;">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
        ...
        <a class="d-btn d-btn-primary" href="{{ route('admin.nutrition_templates.create') }}">Nueva plantilla</a>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                <a class="d-btn d-btn-outline" href="{{ route('admin.nutrition_templates.edit', $tpl) }}">Editar</a>
                                <form method="POST" action="{{ route('admin.nutrition_templates.destroy', $tpl) }}" onsubmit="return confirm('¿Eliminar esta plantilla?');">
                                    @csrf
                                    @method('DELETE')
